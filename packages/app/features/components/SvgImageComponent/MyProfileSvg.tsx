import Svg, { Path, Defs, Image, Pattern, Circle, Use } from 'react-native-svg'
export function MyProfileSvg() {
  return (
    <Svg
      width={92}
      height={92}
    ...
    >
      <Circle cx={46} cy={46} r={46} fill="url(#pattern0)" />
      <Defs>
        <Pattern
          id="pattern0"
